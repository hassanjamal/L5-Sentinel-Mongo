...
return [
     ...
     */
    'users' => [
        'model' => 'App\Sentinel\EloquentUser',
    ],
    /*
    |--------------------------------------------------------------------------
    | Roles
     ...
     */
    'roles' => [
        'model' => 'App\Sentinel\EloquentRole',
    ],
    /*
    |--------------------------------------------------------------------------
    | Permissions
    ...
    | permission types.
    |
    | 'App\Sentinel\Permissions\StandardPermissions'
     ...
     */
    'persistences' => [
        'model' => 'App\Sentinel\EloquentPersistence',
        'single' => false,
    ],
    /*
    |--------------------------------------------------------------------------
     ...
     */
    'activations' => [
        'model' => 'App\Sentinel\EloquentActivation',
        'expires' => 259200,
        'lottery' => [2, 100],
    ],
    /*
     ...
     */
    'reminders' => [
        'model' => 'App\Sentinel\EloquentReminder',
        'expires' => 14400,
        'lottery' => [2, 100],
    ],
    /*
     ...
     */
    'throttling' => [
        'model' => 'App\Sentinel\EloquentThrottle',
        'global' => [
            'interval' => 900,
            'thresholds' => [
                10 => 1,
